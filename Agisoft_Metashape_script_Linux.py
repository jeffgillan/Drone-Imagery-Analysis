...
##Type the following two lines of code into the command prompt. The first path (on the 2nd line) is the location of this python file. The second path is the location of drone images.
